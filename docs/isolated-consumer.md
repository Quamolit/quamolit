...
QUAMOLIT_CONSUMER_REF=7de9d2edcc12617883702f45a3200d385feabcfd yarn test:consumer
```
...
3. 对消费者 `app.main` 全部 9 个定义严格检查并编译。它不引用 `quamolit.test.*`、手写框架 JS 或 JS sampler Map。
